...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (!passwordRegex.test(form.password)) {
      return "Password must be 8+ chars, include uppercase, lowercase & special character";
    }
    return null;
  };
    ...
    return (
      <Shell>
        ...
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8 backdrop-blur-sm shadow-2xl shadow-black/40 text-center">
          ...
          <p
            className="text-slate-400 text-sm leading-relaxed mb-1"
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          >
            We sent a verification link to
          </p>
          <p
            className="text-violet-400 text-sm font-medium mb-5 truncate"
            style={{ fontFamily: "'DM Mono', monospace" }}
          >
            {registeredEmail}
          </p>

          {/* 24-hr warning banner */}
          <div className="flex items-start gap-3 bg-amber-500/[0.08] border border-amber-500/20 rounded-xl px-4 py-3.5 mb-7 text-left">
            <svg
            ...
            >
              ...
              After that, your link expires and you'll need to create a new
              account.
            </p>
          </div>
          ...
          <Link
            to="/login"
            className="flex items-center justify-center w-full py-3 rounded-xl text-sm font-semibold text-white transition-all duration-200
          ...
          >
            ...
            <span className="text-slate-400">Check your spam folder or </span>
            <Link
              to="/login"
    ...
    <Shell>
      ...
      <div className="mb-8">
        ...
        <p
          ...
          style={{ fontFamily: "'DM Sans', sans-serif" }}
        >
          Join thousands already building with Nexora.
        </p>
      </div>
      ...
      <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-7 backdrop-blur-sm shadow-2xl shadow-black/40">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full mt-2 py-3 rounded-xl text-sm font-semibold text-white relative overflow-hidden group transition-all duration-200
              bg-gradient-to-r from-violet-600 to-violet-500
              hover:from-violet-500 hover:to-cyan-500
              shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40
              active:scale-[0.98]"
